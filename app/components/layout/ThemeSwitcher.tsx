  ...
  return (
    <div className="relative">
      <select
        ...
        className="text-md font-semibold rounded-sm bg-background focus:outline text-text focus:outline-highlight appearance-none px-2 py-1 pr-6 cursor-pointer"
      >
